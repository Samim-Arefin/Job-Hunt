...
class JobListingController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('client.job_listing', compact('jobs','job_categories','job_locations','job_types','job_experiences','job_genders','job_salary_ranges','form_title','form_category','form_location','form_type','form_experience','form_gender','form_salary_range'));
    }
    ...
    {        
        ...
        return view('client.job', compact('job_single','jobs'));
    }
