...
@section('button')
<div>
    <a href="{{ route('admin.package-create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Add</a>
</div>
@endsection
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="example1">
                            ...
                            <tr>
                                ...
                                <th class="px-3" style="text-align:center;">Package Name</th>
                                <th class="px-3" style="text-align:center;">Package Price</th>
