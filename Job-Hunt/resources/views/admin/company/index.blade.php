                                ...
                                <tr>
                                    ...
                                    <td class="pt_10 pb_10">
                                      <div class="d-flex justify-content-center align-items-center gap-2">
                                        <a href="{{ route('admin.companies-details',$item->id) }}" class="btn btn-primary btn-sm">Company Details</a>
                                        <a href="{{ route('admin.companies-jobs',$item->id) }}" class="btn btn-warning btn-sm">Jobs</a>
                                      </div>
                                    </td>
                                    <td class="pt_10 pb_10">
                                     <div class="d-flex justify-content-center align-items-center gap-2">
