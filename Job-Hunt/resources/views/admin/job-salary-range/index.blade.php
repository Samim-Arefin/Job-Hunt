...
@section('button')
<div>
    <a href="{{ route('admin.job-salary-range-create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Add</a>
</div>
@endsection
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="example1">
                            ...
                            <tr>
                                ...
                                <th class="px-3" style="text-align:center;">Job Salary Range</th>
                                ...
                                <tr>
                                    ...
                                    <td class="pt_10 pb_10">
                                     <div class="d-flex justify-content-center align-items-center gap-2">
                                        <a href="{{ route('admin.job-salary-range-edit', $item->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="d-flex justify-content-end align-items-center gap-2 px-3 pb-3">
                                                        ...
                                                        <div>
                                                            <form action="{{ route('admin.job-salary-range-delete', $item->id) }}" method="POST">
                                                            @csrf
