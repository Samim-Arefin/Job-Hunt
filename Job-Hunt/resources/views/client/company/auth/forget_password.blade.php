...
@section('title', 'Company Forget Password') 
...
<div class="page-top" style="background-image: url('{{ asset('uploads/banner.jpg') }}')">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 style="color: aliceblue;">Company Forget Password</h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
            <div class="login-form">
                <div class="card" style="margin: 10px auto; padding: 40px 30px 20px 30px; background-color: #e9eff3; border-radius: 15px;">
                    <div class="card-body">
                        <form action="{{ route('auth.company-forget-password-submit') }}" method="post">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <a href="{{ route('auth.company-login') }}" style="color: #03a9f4;">Back to Login Page</a>
                            </div>
                        </form>
                    </div>
                </div>
