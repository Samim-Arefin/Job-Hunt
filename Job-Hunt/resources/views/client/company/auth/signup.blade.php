...
<div class="page-top" style="background-image: url('{{ asset('uploads/banner.jpg') }}')">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 style="color: aliceblue;">Company Sign Up</h2>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row justify-content-center">
        <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
            <div class="card" style="margin: 10px auto; padding: 40px 30px 20px 30px; background-color: #e9eff3; border-radius: 15px;">
                <div class="card-body">
                    <form action="{{ route('auth.company-signup-submit') }}" method="post">
                        @csrf
                        <div class="mb-3">
                            <label style="margin-left: 1rem; font-weight: 600; color: #555;" for="Name" class="form-label">Company Name</label>
                            <input
                        ...
                        <div class="mb-3">
                            <label style="margin-left: 1rem; font-weight: 600; color: #555;" for="Email" class="form-label">Company Email</label>
                            <input
                                style="border-radius: 20px; box-shadow: inset 8px 8px 8px #cbced1, inset -8px -8px 8px #fff;"
                                type="text"
                        ...
                        <div class="mb-3">
                            ...
                            <a href="{{ route('auth.company-login') }}" style="color: #03a9f4;">Existing Company? Login Now</a>
                        </div>
                    </form>
                </div>
            </div>
