        ...
        <div class="row">
            <div class="col-md-12 job job-single">
                <div class="item d-flex justify-content-start">
                    ...
                    <div class="text">
                        <h3>{{ $job_single->title }}, {{ $job_single->rCompany->name }}</h3>
                        ...
                        <div class="apply">
                            @if(date('Y-m-d') <= $job_single->deadline)
                            <a href="{{ route('user.apply',$job_single->id) }}" class="btn btn-primary">Apply Now</a>
                            <a href="{{ route('user.bookmark',$job_single->id) }}" class="btn btn-primary save-job">Bookmark</a>
                            @endif
                        </div>
                        @endif
