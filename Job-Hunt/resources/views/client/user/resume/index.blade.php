...
@section('main-section')
    <div class="page-top" style="background-image: url('{{ asset('uploads/banner.jpg') }}')">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 style="color: aliceblue;">User Resumes</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12">
                <a href="{{ Route('user.resume-create') }}" class="btn btn-primary btn-sm mb-2"><i class="fas fa-plus"></i> Add Item</a>
                            ...
                            <tr style="background: white; color:grey;font-weight:400;">
                                ...
                                <td class="pt_10 pb_10">
                                    <div class="d-flex justify-content-center align-items-center gap-2">
                                        <a href="{{ route('user.resume-edit', $item->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                        <form action="{{ route('user.resume-delete', $item->id) }}" method="POST">
                                            @csrf
