    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                ...
                @if($company_single->mon!=null||$company_single->tue!=null||$company_single->wed!=null||$company_single->thu!=null||$company_single->fri!=null)
                <div class="left-item">
                    <h2>
                        <i class="fas fa-file-invoice"></i>
                        Opening Hours
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    <td>Monday</td>
                                    <td style="text-align: center">{{ $company_single->mon }}</td>
                                </tr>
                                <tr>
                                    <td>Tuesday</td>
                                    <td style="text-align: center">{{ $company_single->tue }}</td>
                                </tr>
                                <tr>
                                    <td>Wednesday</td>
                                    <td style="text-align: center">{{ $company_single->wed }}</td>
                                </tr>
                                <tr>
                                    <td>Thursday</td>
                                    <td style="text-align: center">{{ $company_single->thu }}</td>
                                </tr>
                                <tr>
                                    <td>Friday</td>
                                    <td style="text-align: center">{{ $company_single->fri }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="item d-flex justify-content-start">
                                        ...
                                        <div class="text">
                                            <h3><a href="{{ route('job',$item->id) }}">{{ $item->title }}, {{ $company_single->name }}</a>
                                            </h3>
                                            <div class="detail-1 d-flex justify-content-start">
                                                <div class="category">
                ...
                <div class="right-item">
                    ...
                    <div class="enquery-form">
                        <form action="{{ route('company_enquery_send_email') }}" method="post">
                            ...
                            <div class="mb-3">
                                <input type="text" name="visitor_name" class="form-control @error('visitor_name') is-invalid @enderror" placeholder="Name">
                                @error('visitor_name')
                                  <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                <input type="email" name="visitor_email" class="form-control @error('visitor_email') is-invalid @enderror" placeholder="Email Address">
                                @error('visitor_email')
                                  <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                <input type="text" name="visitor_phone" class="form-control @error('visitor_phone') is-invalid @enderror" placeholder="Phone Number">
                                @error('visitor_phone')
                                  <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                <textarea name="visitor_message" class="form-control h-150 @error('visitor_message') is-invalid @enderror" rows="3" placeholder="Message"></textarea>
